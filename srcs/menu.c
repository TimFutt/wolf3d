...
void	menu(t_mlx *e)
{
	...
	if (e->choice == 1)
	{
		...
		e->data = mlx_xpm_file_to_image(e->ptr, "img/xpm/START.xpm", &i, &i);
...
void	menu2(t_mlx *e)
{
	...
	if (e->choice == 2)
	{
		...
		e->data = mlx_xpm_file_to_image(e->ptr, "img/xpm/MENU.xpm", &i, &i);
		mlx_put_image_to_window(e->ptr, e->win, e->data, 0, 0);
		ft_put_str(e);
		mlx_key_hook(e->win, key_hook_menu, e);
	...
	else if (e->choice == 3)
	{
		...
		e->data = mlx_xpm_file_to_image(e->ptr, "img/xpm/SETTINGS.xpm", &i, &i);
		mlx_put_image_to_window(e->ptr, e->win, e->data, 0, 0);
		ft_put_str(e);
...
void	menu3(t_mlx *e)
{
	...
	if (e->choice == 4)
	{
		...
		e->data = mlx_xpm_file_to_image(e->ptr, "img/xpm/DIFF.xpm", &i, &i);
		mlx_put_image_to_window(e->ptr, e->win, e->data, 0, 0);
		ft_put_str(e);
	...
	else if (e->choice == 5)
	{
		...
		e->data = mlx_xpm_file_to_image(e->ptr, "img/xpm/RESO.xpm", &i, &i);
		mlx_put_image_to_window(e->ptr, e->win, e->data, 0, 0);
		ft_put_str(e);
